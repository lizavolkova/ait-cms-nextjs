...
export const COLOR_API_URL = '/api/color'

export const INSTAGRAM_API_URL = '/api/instagram'
export const INSTAGRAM_USER_NAME = 'adventures.in.mini'

export const AWS_GET_IMAGES_URL = 'https://opxxbb1zq6.execute-api.us-east-1.amazonaws.com/dev/images'
export const AWS_UPLOAD_IMAGES_URL = 'https://opxxbb1zq6.execute-api.us-east-1.amazonaws.com/dev/uploadImages'
export const AWS_SIGNED_URL = 'https://opxxbb1zq6.execute-api.us-east-1.amazonaws.com/dev/signed-url'
